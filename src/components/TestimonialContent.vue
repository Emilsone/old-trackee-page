<template>
  <section>
    <div
      class="my-10 md:my-24 container mx-auto flex flex-col md:flex-row shadow-sm overflow-hidden h-full"
    >
      <div
      ...
      >
        ...
        >
          <div class="top-0 left-0 mt-3 ml-4 md:mt-6 md:ml-4">
            <svg
              ...
              class="text-color fill-current w-12 h-12 md:w-10 md:h-10"
              viewBox="0 0 24 24"
            >
              <path
        ...
        <div
          class="absolute bottom-0 left-0 z-10 md:w-40 md:h-40 md:ml-24 md:mt-24"
        >
          <img src="../assets/Group-one.png" alt="" />
        </div>
      </div>
...
import TestimonialActive from "@/components/TestimonialActive.vue";
